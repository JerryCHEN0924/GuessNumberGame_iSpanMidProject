...
@WebFilter(filterName = "FilterAfterLoginCheckTemp", urlPatterns = {"/registerMemberTemp.jsp"}, /* urlPatterns用以設定攔截的路徑(*表示全部路徑) */
...
public class FilterAfterLoginCheckTemp extends HttpFilter implements Filter { //HttpFilter類別始於JavaEE 8(Servlet 4.0)	
