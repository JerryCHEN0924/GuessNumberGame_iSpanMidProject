...
<div class="container border w-75 mt-5">
	...
	<h2>全部玩家遊戲紀錄查詢管理系統</h2>
	
	<div class="offset-sm-1 col-sm-10 my-3">
	
	
			<form method="get" action="<c:url value='/QueryAllGamingRecordsByIdOrUsernameServletTemp' />">
				...
				<div class="row">
					...
					<label for="username" class="col-sm-1 col-form-label text-end">帳號</label>
					<div class="col-sm-3">
				...
				<tbody>
					<tr>
						...
						<tr class="align-middle">
							...
							<td><a class="btn btn-warning float-end" href="<c:url value='/FindPlayerRecordByIdServletTemp?id=${record.gamingRecordId}' />">修改</a></td>
